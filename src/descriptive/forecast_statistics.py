...
# %%
flights_data_path = os.path.join(
    os.path.expanduser("~"), "Documents", "maps_argentina", "base_microdatos.csv"
)
...
print(
    f"Testing will go from {test_vuelos_cordoba_df.index.min()} to {test_vuelos_cordoba_df.index.max()}"
)
print(
    f"Validation will go from {validate_vuelos_cordoba_df.index.min()} to {validate_vuelos_cordoba_df.index.max()}"
)
# %%
# Data visualization
